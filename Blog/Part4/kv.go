...
func main() {
	...
	// Load/Import constant lookup table from DB to memory
	...
	// Now incremenet the data in the database directly
	...
	// Print to compare the result

	fmt.Println("RESULT 2 (incremented values): ",const_STtype)

	// This is how we'd refer to the loaded data in Go
