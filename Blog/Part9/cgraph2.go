...
func main() {
	...
	links := []S.Link{
		...
		S.Link { 
			...
			To: "Nodes/node2",
			SId: "CONNECTED",
			Weight: 1,           // Initialize all the same, positive 1
		},
	...
	//TestUpsert(g, "EdgeMatrix", "NodeTmpFrom", "NodeTmpTwo")
	...
	fmt.Println("Normalize the result: divide all by sum = 168 --> (32/168 = 0.19, ..., 40/168=0.23)")
}
